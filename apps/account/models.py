...
class User(AbstractUser):
    ...
    email = models.EmailField(_("email address"), blank=True, unique=True, validators=[validate_email])
    ...
    phone_number =models.CharField(_("Phone number"), max_length=11, unique=True, validators=[validate_phone_number])
